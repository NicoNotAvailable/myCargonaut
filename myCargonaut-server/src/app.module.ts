...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      type: 'sqlite',
      database: './db.sqlite',
      entities: [UserDB, CarDB, LocationDB, ReviewDB, TrailerDB, TripDB, VehicleDB],
      synchronize: true,
    }),
    TypeOrmModule.forFeature([UserDB, CarDB, LocationDB, ReviewDB, TrailerDB, TripDB, VehicleDB]),
  ],
